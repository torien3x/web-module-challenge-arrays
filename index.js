...
let newFlavorArray = addFlavor(originalFlavors, 'Rainbow Sherbert')
console.log('addFlavor', newFlavorArray);
...
let removeFlavor = removeLastFlavor(originalFlavors)
console.log('removeLastFlavor', removeFlavor);
...
let flavorName = getFlavorByIndex(originalFlavors, 2);
console.log('flavorName', flavorName);
...
function removeFlavorByName(arr, str) {
  let newArr = arr.filter((flavor) => flavor !== str)
  return newArr;
}

let nameOfFlavor = removeFlavorByName(originalFlavors, 'Rocky Road');
console.log('nameOfFlavor', nameOfFlavor);
...
let wordFilter = filterByWord(originalFlavors, 'Chocolate');
